...
\begin{figure}
	\centering
	\subfigure[SigninActivity]{
	    \includegraphics[height=5cm]{screenshots/login}
	    \label{fig:serverList}
	}
	\hfill
	\subfigure[PasswordManagerActivity]{
		\includegraphics[height=5cm]{screenshots/password_activity}
		\label{fig:pw_activity}
		}
	\hfill
	\subfigure[Edit server dialog]{
	    \includegraphics[height=5cm]{screenshots/edit_server}
	    \label{fig:edit_server}
	}
